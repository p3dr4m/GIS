...
#ifndef FINALPROJALGO_LOGGER_H
#define FINALPROJALGO_LOGGER_H
...
class Logger {
  ...
  private:
    int cmdNum = 0;
    std::string worldLog = "Latitude / longitude values in index entries are shown as floating point values, in decimal long/lat format."+ separator + "\t\t\t\t\t\tWorld boundaries are set to:\n";
